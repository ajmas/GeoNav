...
/**
 *  This represent a heading compass. The top always displays the
 *  heading and the arrows keep tracks of where the north is.
 *
 */
public class HeadingCompassView extends AbstractNMEAInspector {

    /** */
    private static final long serialVersionUID = 6425549534307315988L;
    ...
    private void init ()
    {
        JFrame f = new JFrame("Compass: Heading");
        f.setBounds(500,100,200,200);
        f.add(this);
        f.setVisible(true);
    }
    ...
    void paintNorthPoint( Graphics2D g2d, double adj, int maxSize )
    {
    ...
    public void paintComponent( Graphics g )
    {
        ...
        String headingStr = headingTrue+"";
        Rectangle2D bounds = g2d.getFontMetrics().getStringBounds(headingStr,g2d);
        
        g2d.drawString(headingStr,(float)(-bounds.getWidth()/2),(float)(-bounds.getHeight()/2));
        //paintNorthPoint(g2d,adj,maxSize);
